...
def dashboard():
    ...
    if len(df) == 0:
        ...
        avg_usage = kpis["avg_usage"]
        avg_academic = kpis["avg_academic"]
        avg_stress = kpis["avg_stress"]
        avg_sleep = kpis["avg_sleep"]
        avg_anxiety = kpis["avg_anxiety"]
        total_students = kpis["total_students"]
        summary_stats = analytics.summary_statistics()
        avg_correlation = analytics.get_correlation()
        platform_data = analytics.get_platform_data()
        grouped_data = analytics.grouped_analysis()
    ...
    return render_template(
        ...
        stress_age="Images/stress_age.png",
        bar_chart2="Images/bar_chart2.png",
